...
#ifndef ACTION_TUTORIALS__ACTION__DETAIL__FIBONACCI__TRAITS_HPP_
#define ACTION_TUTORIALS__ACTION__DETAIL__FIBONACCI__TRAITS_HPP_
...
template<>
struct is_message<action_tutorials::action::Fibonacci_Goal>
  : std::true_type {};
...
template<>
struct is_message<action_tutorials::action::Fibonacci_Result>
  : std::true_type {};
...
template<>
struct is_message<action_tutorials::action::Fibonacci_Feedback>
  : std::true_type {};
...
// Member 'goal'
#include "action_tutorials/action/detail/fibonacci__traits.hpp"
...
template<>
struct is_message<action_tutorials::action::Fibonacci_SendGoal_Request>
  : std::true_type {};
...
template<>
struct is_message<action_tutorials::action::Fibonacci_SendGoal_Response>
  : std::true_type {};
...
template<>
struct is_service<action_tutorials::action::Fibonacci_SendGoal>
  : std::true_type
{
};

template<>
struct is_service_request<action_tutorials::action::Fibonacci_SendGoal_Request>
  : std::true_type
{
};

template<>
struct is_service_response<action_tutorials::action::Fibonacci_SendGoal_Response>
  : std::true_type
{
};
...
template<>
struct is_message<action_tutorials::action::Fibonacci_GetResult_Request>
  : std::true_type {};
...
template<>
struct is_message<action_tutorials::action::Fibonacci_GetResult_Response>
  : std::true_type {};
...
template<>
struct is_service<action_tutorials::action::Fibonacci_GetResult>
  : std::true_type
{
};

template<>
struct is_service_request<action_tutorials::action::Fibonacci_GetResult_Request>
  : std::true_type
{
};

template<>
struct is_service_response<action_tutorials::action::Fibonacci_GetResult_Response>
  : std::true_type
{
};
...
template<>
struct is_message<action_tutorials::action::Fibonacci_FeedbackMessage>
  : std::true_type {};
...
template<>
struct is_action<action_tutorials::action::Fibonacci>
  : std::true_type
{
};

template<>
struct is_action_goal<action_tutorials::action::Fibonacci_Goal>
  : std::true_type
{
};

template<>
struct is_action_result<action_tutorials::action::Fibonacci_Result>
  : std::true_type
{
};

template<>
struct is_action_feedback<action_tutorials::action::Fibonacci_Feedback>
  : std::true_type
{
};
...
#endif  // ACTION_TUTORIALS__ACTION__DETAIL__FIBONACCI__TRAITS_HPP_
